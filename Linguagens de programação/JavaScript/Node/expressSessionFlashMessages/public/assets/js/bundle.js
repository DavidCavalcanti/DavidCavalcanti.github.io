...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --primary-color: rgb(13,106,134);\n    --primary-color-darker:  rgb(9, 48, 56);\n}\n\n*{\n    box-sizing: border-box;\n    outline: 0;\n\n}\n\nbody{\n    margin: 0;\n    padding: 0;    \n    background: var(--primary-color);\n    font-family: 'open Sans', sans-serif ;\n}\n\n.container{\n     max-width: 640px;\n     margin: 50px auto;\n     border-radius: 10px;\n     background-color: #ffffff;\n     padding: 20px;\n     \n     \n}\n\nform input, form label, form button {\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\nform input{\n    font-size: 24px;\n    height: 30px;\n    padding: 0 10px;   \n}\n\nform input:focus{\n    outline: 1px solid var(--primary-color);\n}\n\nform button {\n    border: none;\n    background: var(--primary-color);\n    color: #fff;\n    font-size: 24px;\n    font-weight: 700;\n    height: 50px;\n    cursor: pointer;\n    margin-top: 30px;\n\n}\n\nform button:hover{\n    background-color: var(--primary-color-darker);\n}\n\nform button:active{\n    background: rgb(7, 222, 238);\n}", "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAEA;IACI,gCAAgC;IAChC,uCAAuC;AAC3C;;AAEA;IACI,sBAAsB;IACtB,UAAU;;AAEd;;AAEA;IACI,SAAS;IACT,UAAU;IACV,gCAAgC;IAChC,qCAAqC;AACzC;;AAEA;KACK,gBAAgB;KAChB,iBAAiB;KACjB,mBAAmB;KACnB,yBAAyB;KACzB,aAAa;;;AAGlB;;AAEA;IACI,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,YAAY;IACZ,gCAAgC;IAChC,WAAW;IACX,eAAe;IACf,gBAAgB;IAChB,YAAY;IACZ,eAAe;IACf,gBAAgB;;AAEpB;;AAEA;IACI,6CAA6C;AACjD;;AAEA;IACI,4BAA4B;AAChC","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap');\n\n:root{\n    --primary-color: rgb(13,106,134);\n    --primary-color-darker:  rgb(9, 48, 56);\n}\n\n*{\n    box-sizing: border-box;\n    outline: 0;\n\n}\n\nbody{\n    margin: 0;\n    padding: 0;    \n    background: var(--primary-color);\n    font-family: 'open Sans', sans-serif ;\n}\n\n.container{\n     max-width: 640px;\n     margin: 50px auto;\n     border-radius: 10px;\n     background-color: #ffffff;\n     padding: 20px;\n     \n     \n}\n\nform input, form label, form button {\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\nform input{\n    font-size: 24px;\n    height: 30px;\n    padding: 0 10px;   \n}\n\nform input:focus{\n    outline: 1px solid var(--primary-color);\n}\n\nform button {\n    border: none;\n    background: var(--primary-color);\n    color: #fff;\n    font-size: 24px;\n    font-weight: 700;\n    height: 50px;\n    cursor: pointer;\n    margin-top: 30px;\n\n}\n\nform button:hover{\n    background-color: var(--primary-color-darker);\n}\n\nform button:active{\n    background: rgb(7, 222, 238);\n}"],"sourceRoot":""}]);
// Exports
